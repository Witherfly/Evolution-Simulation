...
def main():
    ...
    death_func3 = Zone_selection(("circle", "east_west"), (0.10, 0.05), world_shape)
    ...
    world = World(world_shape=world_shape, n_population=120, n_steps=80, n_max_gen=n_max_gen,
                ...
                kill_enabled=kill_enabled, wall_mask=wall_mask1, death_func=death_func3,
